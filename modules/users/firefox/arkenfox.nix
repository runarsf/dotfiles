{outputs, ...}: {
  ...
  hardened = {
    "0700"."0701".enable = outputs.lib.mkForce true;
    "0800" = {
      "0801"."keyword.enabled".value = outputs.lib.mkForce false;
      "0810"."browser.formfill.enable".value = outputs.lib.mkForce false;
    };
    # Disable WebRTC
    "2000" = {
      enable = true;
    ...
    "2800" = {
      enable = true;
      "2811"."privacy.clearOnShutdown.history".enable = outputs.lib.mkForce true;
    };
