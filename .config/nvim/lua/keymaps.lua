...
--vim.cmd("cnoreabbrev q <CMD>lua require'util'.Bbq()<CR>")
--cfg.map("n", "<leader>wq", "<CMD>lua require'util'.Bbq(true)<CR>")
--vim.cmd("cnoreabbrev wq <CMD>lua require'util'.Bbq(true)<CR>")
