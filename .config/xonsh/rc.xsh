...
if !(test -f "~/.local/share/miniconda3/bin/conda"):
    ...
    _mod = _ModuleType("xontrib.conda",
                    "Autogenerated from $(~/.local/share/miniconda3/bin/conda shell.xonsh hook)")
    __xonsh__.execer.exec($("~/.local/share/miniconda3/bin/conda" "shell.xonsh" "hook"),
                        glbs=_mod.__dict__,
                        filename="$(~/.local/share/miniconda3/bin/conda shell.xonsh hook)")
